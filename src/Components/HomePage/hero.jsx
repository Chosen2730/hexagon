...
const Hero = () => {
  ...
  return (
    <div className='relative z-10 hero_slide' ref={hero}>
      ...
      <div
        className='flex items-center justify-center scroll absolute bottom-32 w-full'
        onClick={scrollBelow}
      >
        <AiOutlineArrowDown className='w-12 md:w-16 h-12 md:h-16 p-2 bg-white text-pry rounded-full' />
      </div>
    </div>
  );
};
